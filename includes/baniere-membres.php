...
<?php
    ...
    if(isset($_SESSION['pseudo'])){
        echo '<p class="p_baniere_petit_pseudo"> <a href="voirprofil.php?m='.$_SESSION['id'].'&amp;action=consulter">'
        ...
        if(!empty($_SESSION['avatar'])){
           ...
           echo '<p class="p_baniere_petit"><img class="roundedImage" src="avatars/compte100.png" alt="Avatar" title="Voir mon profil" /></a>';}
