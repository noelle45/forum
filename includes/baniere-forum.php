...
<?php
    ...
    if(isset($_SESSION['pseudo'])){
        ...
        if(!empty($_SESSION['avatar'])){
            echo '<p class="p_baniere_petit""><img class="roundedImage" src="../membres/avatars/'.$_SESSION['avatar'].'" alt="Avatar" title="Voir mon profil"/>';}
        else{
           echo '<p class="p_baniere_petit""><img class="roundedImage" src="../membres/avatars/compte100.png" alt="Avatar" title="Voir mon profil" /></a>';}
