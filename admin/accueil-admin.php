...
echo'<p><i>Vous êtes ici</i> : <a href="accueil-admin.php">Accueil Administration</a>';
...
switch($cat) //1er switch
{
        ...
        echo '<form method="post" action="adminok.php?cat=config">';
            ...
            {
                   echo '<p><label for='.$data['config_nom'].'>'.$config_name[$data['config_nom']].' </label> :<br/>
...
//***********************************************************************************************************************
 ...
 //--------------------
        case "creer":
                ...
                if(empty($_GET['c']))
                {
                        echo'<h2>Que voulez-vous faire?</h2><br />
                        <p><a href="accueil-admin.php?cat=forum&action=creer&c=f">Créer un forum</a><br />
                        <a href="accueil-admin.php?cat=forum&action=creer&c=c">Créer une catégorie</a></p></br>';
                }
                ...
                elseif($_GET['c'] == "f")
                {
                        ...
                        echo'<h1>Création d\'un forum</h1><br />';
                        echo'<form method="post" action="adminok.php?cat=forum&action=creer&c=f">';
                        echo'<label>Nom :</label><br /><input type="text" id="nom" name="nom" /><br />
                ...
                elseif($_GET['c'] == "c")
                {
                        echo'<h1>Création d\'une catégorie</h1><br />';
                        echo'<form method="post" action="adminok.php?cat=forum&action=creer&c=c">';
                        echo'<label> Indiquez le nom de la catégorie :</label><br />
 ...
 //------------------------      
            case "edit":
                echo'<h1>Edition d\'un forum</h1><br />';

                if(!isset($_GET['e']))
                {
                        echo'<h2>Que voulez vous faire ?</h2><br />
                       <p> <a href="accueil-admin.php?cat=forum&action=edit&amp;e=editf">
                        Editer un forum</a><br />
                        <a href="accueil-admin.php?cat=forum&action=edit&amp;e=editc">
                        Editer une catégorie</a><br />
                        <a href="accueil-admin.php?cat=forum&action=edit&amp;e=ordref">
                        Changer l ordre des forums</a><br />
                        <a href="accueil-admin.php?cat=forum&action=edit&amp;e=ordrec">
                        Changer l ordre des catégories</a></p>
                        <br />';
                }
                elseif($_GET['e'] == "editf")
                {
                ...
                echo'<form method="post" action="accueil-admin.php?cat=forum&amp;action=edit&amp;e=editf">';
                 ...
                 elseif($_GET['e'] == "editc")
                {
                    ...
                    $query = $db->query('SELECT cat_id, cat_nom
                    FROM forum_categorie ORDER BY cat_ordre DESC');
                    echo'<form method="post" action="accueil-admin.php?cat=forum&amp;action=edit&amp;e=editc">';
...
//-----------------------------------
        case "droits":
            ...
            if(!isset($_POST['forum']))
            {
                $query=$db->query('SELECT forum_id, forum_name
                FROM forum_forum ORDER BY forum_ordre DESC');
                echo'<form method="post" action="accueil-admin.php?cat=forum&action=droits">';
            ...
            <input type="submit" value="Envoyer"></form></table>';
            }
            $query->CloseCursor();	
        break;
//-----------------------------
        ...
        echo'<h2>Que souhaitez-vous faire ?</h2>
        <br />';
        echo '<p><a href="accueil-admin.php?cat=forum&amp;action=creer">Créer un forum</a>
        <br /><br />
        <a href="accueil-admin.php?cat=forum&amp;action=edit">Modifier un forum</a>
        <br /><br />
        <a href="accueil-admin.php?cat=forum&amp;action=droits">
    ...
    switch($action) //2ème switch
    {
        case "edit":
            ...
            if(!isset($_POST['membre'])) //Si la variable $_POST['membre'] n'existe pas
            {
                ...
                echo'<br /><form method="post" action="accueil-admin.php?cat=membres&amp;action=edit">
            ...
            cliquez <a href="accueil-admin.php?cat=membres&amp;action=edit">ici</a> pour réessayez</p>';
        }
        break;
//-----------------------       
        case "droits":
            ...
            if(!isset($_POST['membre']))
            {
                    ...
                    echo'<br /><form method="post" action="accueil-admin.php?cat=membres&action=droits">
                    <p><label for="membre">Inscrivez le pseudo : </label> 
            ...
            <input type="submit" value="Envoyer"></form>';
                ...
                cliquez <a href="accueil-admin.php?cat=membres&amp;action=edit">ici</a> pour réessayer</p>';
            }
        break;
//--------------------------        
        case "ban":
...
//---------------------            
        ...
        <a href="accueil-admin.php?cat=membres&amp;action=edit">
        Editer le profil d un membre</a><br />
        <a href="accueil-admin.php?cat=membres&amp;action=droits">
        Modifier les droits d un membre</a><br />
        <a href="accueil-admin.php?cat=membres&amp;action=ban">
...
echo'<p style="text-align:center">Bienvenue sur la page d\'administration</p><br /><br />
<p><a href="accueil-admin.php?cat=config">Configuration du forum</a><br /><br />
<a href="accueil-admin.php?cat=forum">Administration des forums</a><br /><br />
<a href="accueil-admin.php?cat=membres">Administration des membres</a></p><br /><br />';
break;
}
