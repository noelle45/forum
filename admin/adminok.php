...
case "config":
    ...
    Cliquez <a href="accueil-admin.php">ici</a> pour revenir à l administration';
break;
	...
	if ($_GET['c'] == "f")
	{
        ...
        elseif ($_GET['c'] == "c")
        {
            ...
            $query->bindValue(':titre',$titre, PDO::PARAM_STR); 
            $query->execute();          
            echo'<p>La catégorie a été créée !<br /> Cliquez <a href="accueil-admin.php">ici</a> 
    ...
    break;
     ...
     case "edit":
	    ...
	    $cat = (int) $_POST['depl'];       
            ...
            $query->CloseCursor();
            //Message
            echo'<p>Le forum a été modifié !<br />Cliquez <a href="accueil-admin.php">ici</a> 
            pour revenir à l administration</p>';
            ...
            elseif($_GET['e'] == "editc")
        {
            ...
            Cliquez <a href="accueil-admin.php">ici</a> 
            pour revenir à l administration</p>';
        ...
        Cliquez <a href="accueil-admin.php">ici</a> pour revenir à l administration</p>';
        }
     ...
     case "ban":
        ...
        if (isset($_POST['membre']) AND !empty($_POST['membre']))
        {
            ...
            else 
            {
                ...
                <br />
                Cliquez <a href="accueil-admin.php?cat=membres&action=ban">ici</a> 
                pour réessayer</p>';
            }
        }
        //Debannissement ici        
	    ...
	    if ($i!=0)
            ...
            Cliquez <a href="accueil-admin.php">ici</a> pour retourner à l administration</p>';
        }
    break;
    }
break;
